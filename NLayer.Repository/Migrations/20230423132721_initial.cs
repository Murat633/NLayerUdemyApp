    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2023, 4, 23, 16, 27, 21, 493, DateTimeKind.Local).AddTicks(4231), "Kitap", 100m, 20, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreatedDate", "Name", "Price", "Stock", "UpdatedDate" },
                values: new object[] { 2, 2, new DateTime(2023, 4, 23, 16, 27, 21, 493, DateTimeKind.Local).AddTicks(4243), "Kalem", 300m, 20, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreatedDate", "Name", "Price", "Stock", "UpdatedDate" },
                values: new object[] { 3, 2, new DateTime(2023, 4, 23, 16, 27, 21, 493, DateTimeKind.Local).AddTicks(4245), "Kitap", 300m, 20, null });
